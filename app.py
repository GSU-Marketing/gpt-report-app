...
if view == "Page 1: Funnel Overview":
    ...
    if "Person Citizenship" in filtered_df.columns:
        domestic_count = filtered_df[filtered_df["Person Citizenship"] == "United States"].shape[0]
        international_count = filtered_df[filtered_df["Person Citizenship"] != "United States"].shape[0]
        citizenship_df = pd.DataFrame({"Type": ["Domestic", "International"], "Count": [domestic_count, international_count]})
